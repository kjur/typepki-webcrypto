...
// == sigRStoASN1 sigASN1toRS ======================================
describe("sigRStoASN1", () => {
  test("P-256 RS Sig", () => { expect(sigRStoASN1(SIGOSSE256)).toBe(SIGOSSE256ASN); });
  test("P-384 RS Sig", () => { expect(sigRStoASN1(SIGOSSE384)).toBe(SIGOSSE384ASN); });
  test("P-521 RS Sig", () => { expect(sigRStoASN1(SIGOSSE521)).toBe(SIGOSSE521ASN); });
});

describe("sigASN1toRS", () => {
  test("P-256 ASN.1 Sig", () => { expect(sigASN1toRS(SIGOSSE256ASN)).toBe(SIGOSSE256); });
  test("P-384 ASN.1 Sig", () => { expect(sigASN1toRS(SIGOSSE384ASN)).toBe(SIGOSSE384); });
  test("P-521 ASN.1 Sig", () => { expect(sigASN1toRS(SIGOSSE521ASN)).toBe(SIGOSSE521); });
});

// == sigRStoASN1 sigASN1toRS (END)=================================
...
const SIGOSSE256S1 =
  "29d8716fd81ccbb579a4c5d14678f15250a70dc5dc8dc406e8f9dea240704256a343f16cedb33b9606acbbbb52d634d8b835a27a90b9f52f64c620fdcf0a1b34";

// testecp256.aaa.sha256.sig
const SIGOSSE256 =
  "69c3e2489cc23044f91dce1e5efab7a47f8c2a545cdce9b58e408c6a2aabd06076ba3d70771c00451adcf608d93f20cc79ccaf872f42028aa05ff57b14e5959f";
const SIGOSSE256ASN =
  "3044022069c3e2489cc23044f91dce1e5efab7a47f8c2a545cdce9b58e408c6a2aabd060022076ba3d70771c00451adcf608d93f20cc79ccaf872f42028aa05ff57b14e5959f";

// testecp384.aaa.sha384.sig
const SIGOSSE384 =
  "cb6c3115a81bfb7581df9bd05e4116ed90f483fdbe03c8c8204c6d2a9bba7520580dfb86f5649ad2de5fce59b67b4b6159924fcd38c995d782d33f1750134cbef6e609558fa6d7e6a0eff7d32b90a48df5eb9fed839fa492cb9da50a017a0f12";
const SIGOSSE384ASN =
  "3065023100cb6c3115a81bfb7581df9bd05e4116ed90f483fdbe03c8c8204c6d2a9bba7520580dfb86f5649ad2de5fce59b67b4b61023059924fcd38c995d782d33f1750134cbef6e609558fa6d7e6a0eff7d32b90a48df5eb9fed839fa492cb9da50a017a0f12";
...
const SIGOSSE521 =
  "";
const SIGOSSE521ASN =
  "";
